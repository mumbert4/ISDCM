 ...
 * @author alumne
 */
@WebServlet(name = "ServletReproduccion", urlPatterns = {"/ServletReproduccion"})
@MultipartConfig
public class ServletReproduccion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("get ServletReproduccion");
        System.out.println(videoId);
        Video v = new Video(Integer.parseInt(videoId));
